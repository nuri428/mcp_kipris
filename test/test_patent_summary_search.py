...
# 특허 검색 도구 import
from mcp_kipris.kipris.tools.korean.patent_summary_search_tool import PatentSummarySearchTool


def main():
    # 검색 도구 인스턴스화
    tool = PatentSummarySearchTool()

    # 테스트할 출원번호 (삼성전자의 특허 출원번호)
    application_number = "1020200042879"

    print(f"출원번호 {application_number}에 대한 특허 요약 정보 검색 중...")
